...
export const skills: Skill[] = [
  ...
  { name: "Vue Router", level: 4, category: "frontend", color: "#42b883" },
  ...
  { name: "Axios", level: 4, category: "frontend", color: "#5a29e4" },
  { name: "Canvas 2D", level: 3, category: "frontend", color: "#ff6b6b" },
  { name: "Three.js", level: 2, category: "frontend", color: "#049ef4" },
  { name: "Anime.js", level: 2, category: "frontend", color: "#ff4b6e" },
